...
<head>
    ...
    <title>Aplikasi Kasir | by.abdulgani</title>
    <link rel="icon" href="gani.png">
    <link rel="icon" href="gani.png" type="image/ico">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        <div class="user-pic" style="height:72px;width:72px;">
        ...
        <div class="user-info">
          ...
          <span class="user-role">Kasir BUMDes</span>
