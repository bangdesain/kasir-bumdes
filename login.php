...
<head>
    ...
    <title>Login Aplikasi Kasir | by.abdulgani</title>
    <link rel="icon" href="logo-bumdes.png">
    <link rel="icon" href="logo-bumdes.png" type="image/ico">
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/logo-login.png" alt="" width="72" height="72">
     ...
     PKL STMIK SZ NW ANJANI 2023</a></p>
    </form>
